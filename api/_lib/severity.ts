...
export function calculateClinicalSeverity(ai: AISignals, patient: PatientSymptomLog, lang: string = 'en') {
  let score = 0;
  ...
  const reasoningDict: Record<string, Record<string, string>> = {
    ...
    streaking: {
      ...
      te: "క్లిష్టమైన హెచ్చరిక: లింఫాంగైటిస్ (ఎర్రటి గీతలు) గుర్తించబడింది. ఇది సెప్సిస్ ప్రమాదానికి ప్రాథమిక సంకేతం.",
