...
export function calculateClinicalSeverity(
  ...
  if (ai.streaking) {
    ...
    reasoning.push("CRITICAL ALERT: Lymphangitis (red streaking) detected. This is a primary sign of infection entering the lymphatic/vascular system.");
  }
